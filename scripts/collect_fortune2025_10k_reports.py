...
DEFAULT_MANIFEST = Path("config/fortune2025_top100_10k_report_index.csv")
DEFAULT_AUDIT = Path("data/audit/fortune2025_top100_10k_report_audit.csv")
DEFAULT_REPORT_DIR = Path("data/sec_10k/reports")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--cache-dir", type=Path, default=Path("data/sec_10k/cache"))
