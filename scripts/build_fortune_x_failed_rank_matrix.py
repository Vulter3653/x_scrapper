...
def read_matching_ranks(summary_file: Path, statuses: set[str]) -> list[int]:
...
def main() -> int:
    ...
    ranks = read_matching_ranks(summary_file, statuses)
    ...
    print(f"failed_rank_count={len(ranks)} failed_ranks={failed_ranks_csv or 'none'}")
    return 0
